...
//4328/206180/2.49/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "STTS75M2F" (originalName "STTS75M2F")
	...
	(compDef "STTS75M2F" (originalName "STTS75M2F") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "__O.S.__/INT") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "STTS75M2F"))
		...
		(attr "Mouser Part Number" "511-STTS75M2F")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=511-STTS75M2F")
		(attr "Manufacturer_Name" "STMicroelectronics")
		(attr "Manufacturer_Part_Number" "STTS75M2F")
		(attr "Description" "STTS75M2F, 12bit Temperature Sensor +/-3C Serial-I2C 2.7 to 5.5V 8-Pin SOIC")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/STTS75M2F.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "STTS75M2F.stp")
